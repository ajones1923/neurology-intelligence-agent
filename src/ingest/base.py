"""Base ingest parser for the Neurology Intelligence Agent.

Defines the abstract BaseIngestParser interface and the IngestRecord dataclass
that all concrete parsers (PubMed, Neuroimaging, EEG) implement.
...
class IngestRecord:
    ...
    Attributes:
        ...
        source: Data source identifier (e.g., "pubmed", "eeg", "neuroimaging").
    """
